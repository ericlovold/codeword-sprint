...
export function CodewordSentScreen({
  onNavigateToResources,
  onNavigateToChat,
}: CodewordSentScreenProps) {
  return (
    <div
    ...
    >
      ...
      {/* Main Heading */}
      <h1
        className="text-white font-medium chat-text mb-4 max-w-sm"
      ...
      {/* Subhead */}
      <p
        className="text-white/80 chat-text mb-12 max-w-sm"
      ...
      <div className="px-8 pb-8 w-full space-y-4">
        ...
        >
          <img src={aiCoachIcon} alt="AI Coach" className="w-8 h-8" />
          Chat with AI Coach
        </button>
      </div>
    </div>
