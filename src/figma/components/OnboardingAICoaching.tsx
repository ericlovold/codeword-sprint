...
export function OnboardingAICoaching({ onComplete, onBack, currentIndex, totalScreens }: OnboardingAICoachingProps) {
  return (
    <div className="size-full flex flex-col relative" style={{ background: 'linear-gradient(180deg, #f8f9fa 0%, rgba(100, 41, 117, 0.35) 100%)' }}>
