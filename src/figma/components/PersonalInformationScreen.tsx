      ...
      <div className="relative z-10 flex-1 px-6 py-8 overflow-y-auto">
        <div className="max-w-md mx-auto space-y-6">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2 chat-text">Update your profile details</p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-black chat-text font-medium mb-2">Full Name</label>
              <input
                type="text"
          ...
          {/* Save Button */}
          <div className="pt-6">
            <button className="w-full py-4 rounded-full bg-black text-white hover:bg-gray-800 transition-colors chat-text font-medium">
              Save Changes
            </button>
          </div>
        </div>
