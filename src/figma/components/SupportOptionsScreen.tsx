  ...
  return (
    <div className="h-full flex flex-col">
      ...
      >
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-medium text-black chat-text">Get Support</h1>
        </div>
        ...
        <div className="space-y-4 max-w-md mx-auto w-full">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm">
            ...
            <button onClick={handleSetUpAllies} className="text-left w-full">
              <h2 className="text-2xl font-medium text-black chat-text mb-3">Set Up My Allies</h2>
