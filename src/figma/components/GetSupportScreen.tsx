...
export function GetSupportScreen({
  onCodewordSent,
  onManageAllies,
  selectedContacts,
  hasCodewordSetup,
  onNavigateToCodewordSetup,
}: GetSupportScreenProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {/* 988 Lifeline Popup */}
      <LifelinePopup isOpen={showLifelinePopup} onClose={() => setShowLifelinePopup(false)} />
      ...
      >
        {/* Header */}
        <div className="mb-28">
          <h1 className="text-4xl font-medium text-white chat-text">Get Support</h1>
        </div>
