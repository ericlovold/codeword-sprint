      ...
      <div className="relative z-10 flex-1 flex flex-col justify-between px-6 pb-8">
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
          ...
          <p className="text-gray-600 chat-text text-center mb-8 leading-relaxed">
            To ensure your Codeword reaches your allies even when their phones are on Do Not
            Disturb, we need to enable critical alerts and notifications.
          </p>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-medium text-black chat-text">Allow Notifications</h3>
                <div
                  className={`w-6 h-6 rounded-full border flex items-center justify-center ${
                    notificationsEnabled ? 'bg-[#642975] border-[#642975]' : 'border-gray-300'
                  }`}
                >
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-medium text-black chat-text">Critical Alerts</h3>
                <div
                  className={`w-6 h-6 rounded-full border flex items-center justify-center ${
                    criticalAlertsEnabled ? 'bg-[#642975] border-[#642975]' : 'border-gray-300'
                  }`}
                >
