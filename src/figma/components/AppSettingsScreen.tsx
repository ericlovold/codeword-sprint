                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 chat-text">Change app language</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 chat-text">Sync data across devices</p>
                    </div>
                  </div>
                ...
                <button className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-500 chat-text">Free up storage space</p>
                    </div>
                  </div>
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-500 chat-text">Restore default settings</p>
                  </div>
                </button>
                ...
                <button className="w-full flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                  <div className="text-left">
                    ...
                    <p className="text-xs text-gray-500 chat-text">Backup your preferences</p>
                  </div>
                </button>
              </div>
            </div>
