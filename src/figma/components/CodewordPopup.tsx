    ...
    >
      <div className="bg-white rounded-2xl max-w-sm w-full p-6 relative max-h-[80vh] overflow-y-auto">
        ...
        <div className="mb-6 pr-8">
          <p className="text-gray-600 chat-text">Choose an ally to reach out to</p>
        </div>
          ...
          {allies.map((ally) => (
            <div key={ally.id} className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                >
                  <img src={alertIcon} alt="Alert" className="w-8 h-8 object-contain" />
                  <div className="text-left">
                    <div className="font-medium text-black chat-text text-sm">
                      Send Codeword Alert
                    </div>
                    <div className="text-xs text-gray-600 chat-text">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <p className="text-sm text-gray-800 chat-text">
                              <strong>Need help with what to say?</strong> Ask your AI Coach for
                              guidance.
                            </p>
                          </div>
                        </div>
