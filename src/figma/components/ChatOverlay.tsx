...
export function ChatOverlay({ isOpen, onClose, guideTitle }: ChatOverlayProps) {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      let responseText =
        "I understand your situation. Let me provide some guidance based on crisis intervention best practices. Remember, you're taking the right steps by seeking support.";

      if (guideTitle === 'Crisis Communication Support') {
        responseText =
          "That's a great question. Remember to be honest and direct about your feelings. You could also say things like 'I'm having thoughts that worry me' or 'I need someone I trust to know what I'm going through.' Would you like me to help you practice what to say for your specific situation?";
      }
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="p-4 bg-transparent backdrop-blur-sm">
          ...
          >
            ...
            >
              <img src={arrowIcon} alt="Send" className="w-8 h-8 object-contain" />
            </button>
          </form>
        </div>
