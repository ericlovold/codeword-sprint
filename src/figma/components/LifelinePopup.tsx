    ...
    >
      <div className="bg-white rounded-2xl max-w-sm w-full p-6 relative">
        ...
        <div className="mb-6 pr-8">
          <h2 className="text-xl font-medium text-black chat-text mb-2">Contact 988 Lifeline</h2>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-500 chat-text">Talk to a counselor</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-500 chat-text">Chat via text messages</p>
              </div>
            </div>
            <SimpleArrowRight size={16} color="#9CA3AF" />
          </button>
