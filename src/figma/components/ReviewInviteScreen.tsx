    ...
    <div className="h-screen w-full flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 overflow-y-auto">
        <div className="px-6 py-6 pt-12">
          {/* Title */}
          <div className="mb-8">
            <h1 className="text-black text-2xl font-medium chat-text leading-tight mb-4">Review</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6">
              <h3 className="text-black font-medium chat-text text-lg mb-6">Your Codeword Setup</h3>

              {/* Selected Ally */}
              <div className="mb-6">
                <h4 className="text-black font-medium chat-text mb-3">Selected Ally</h4>
                {selectedAlly ? (
                  ...
                  <p className="text-gray-600 chat-text">No ally selected</p>
                )}
              </div>

              {/* Codeword */}
              <div>
                <h4 className="text-black font-medium chat-text mb-3">Your Codeword</h4>
                <span className="text-black font-medium chat-text text-lg">"{codeword}"</span>
              </div>
            </div>

            {/* What happens next */}
            <div>
              <h3 className="text-black font-medium chat-text text-lg mb-4">What happens next?</h3>
