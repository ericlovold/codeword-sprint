          ...
          <div className="max-w-md mx-auto space-y-6">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="email" className="block text-gray-700 chat-text mb-1">
                    Email
                  </label>
                ...
                <div>
                  <label htmlFor="phone" className="block text-gray-700 chat-text mb-1">
                    Phone
                  </label>
                  <div className="flex items-center gap-2">
                ...
                <div>
                  <label htmlFor="joined" className="block text-gray-700 chat-text mb-1">
                    Member Since
                  </label>
                  <div className="flex items-center gap-2">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full py-3 px-4 rounded-md border border-gray-300 text-gray-700 chat-text hover:bg-gray-50 transition-colors">
                Change Password
              </button>

              <button className="w-full py-3 px-4 rounded-md border border-red-300 text-red-600 hover:bg-red-50 chat-text transition-colors">
                Delete Account
              </button>
            </div>
