      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <div className="text-center space-y-8 max-w-sm">
          ...
          <div className="flex justify-center">
            <img src={newCodewordIcon} alt="Codeword" className="w-32 h-32 object-contain" />
          </div>

          {/* Welcome Text */}
          <div className="space-y-4">
            <h1 className="text-3xl font-medium text-white chat-text">Welcome to Codeword</h1>
            <p className="text-base text-white chat-text leading-relaxed opacity-90">
              Your AI companion for emotional support, crisis intervention, and navigating life's
              challenges.
            </p>
          </div>
