...
export function ResourceLibraryScreen({ onNavigate, onNavigateToMoodTracker }: ResourceLibraryScreenProps) {
  ...
  const guides = [
    ...
    },
    {
      ...
      content: [
        { type: "mixed", text: "National Suicide Prevention Lifeline: ", linkText: "Text or Dial 988", href: "tel:988" },
        { type: "mixed", text: "Crisis Text Line: ", linkText: "Text HOME to 741741", href: "sms:741741?body=HOME" },
        { type: "mixed", text: "Local emergency services: ", linkText: "Text or Dial 911", href: "tel:911" },
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(180deg, rgba(100, 41, 117, 0.3) 0%, rgba(100, 41, 117, 0.1) 50%, rgba(100, 41, 117, 0.05) 100%)'
        }}
      >
        <div className="max-w-md mx-auto space-y-4">
                  ...
                  <div className="px-4 pb-4 border-t border-gray-100 relative">
                    <div className="pt-16 space-y-2">
                      {guide.content.map((item, itemIndex) => (
                        <div key={itemIndex} className={`flex items-start ${guide.title === 'Consider external resources' ? 'space-x-0' : 'space-x-3'}`}>
                          {guide.title !== 'Consider external resources' && (
                            <div className="w-1.5 h-1.5 rounded-full bg-purple-600 mt-2 flex-shrink-0 mr-3" style={{ backgroundColor: '#642975' }}></div>
                          )}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 chat-text mb-4 leading-relaxed">
                  Monitor your emotional wellbeing with our mood tracking tool. Identify patterns and triggers to better understand your mental health journey.
                </p>
          ...
          <div className="mt-8 pt-6 border-t border-white/20">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6">
                <h3 className="text-lg font-medium text-gray-900 chat-text mb-3">Find Professional Support</h3>
                <p className="text-sm text-gray-600 chat-text mb-4 leading-relaxed">
                  Connect with licensed therapists and mental health professionals who can provide ongoing support and guidance.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-gray-900 chat-text mb-1">Find a Therapist</h4>
                      <p className="text-xs text-gray-600 chat-text">Find therapists by location, insurance, and specialty</p>
                    </div>
                  </a>
                  ...
                  >
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-gray-900 chat-text mb-1">SAMHSA National Helpline</h4>
                      <p className="text-xs text-gray-600 chat-text">Free, confidential treatment referrals</p>
                    </div>
                  </a>
                  ...
                  >
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-gray-900 chat-text mb-1">National Eating Disorders Association Helpline</h4>
                      <p className="text-xs text-gray-600 chat-text">Reach out for help with eating concerns, body image issues, or disordered eating.</p>
                    </div>
                  </a>
                  ...
                  >
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-gray-900 chat-text mb-1">National Domestic Violence Hotline</h4>
                      <p className="text-xs text-gray-600 chat-text">Get support if you feel controlled, unsafe, or harmed by a partner or family member. Call or text 'START' to 88788.</p>
                    </div>
                  </a>
                </div>
              </div>
