...
export function HelpSupportScreen({ onBack }: HelpSupportScreenProps) {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Your selected ally will receive a notification with your codeword and location if sharing is enabled."
    },
    {
      question: "How do I change my codeword?",
      answer: "You can update your codeword in the Support section by going through the codeword setup again."
    },
    {
      question: "Is my information secure?",
      answer: "Yes, all your data is encrypted and stored securely. We follow industry-standard security practices."
    }
  ];
            ...
            <div className="space-y-4">
              {faqItems.map((item, index) => (
                <div key={index} className="border-b border-gray-100 last:border-b-0 pb-3 last:pb-0">
                  ...
                  <p className="text-xs text-gray-600 chat-text leading-relaxed">
                    {item.answer}
                  </p>
                </div>
              ))}
