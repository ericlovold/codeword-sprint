...
export function OnboardingAllies({ onContinue, onBack, currentIndex, totalScreens }: OnboardingAlliesProps) {
  return (
    <div className="size-full flex flex-col relative" style={{ background: 'linear-gradient(180deg, #f8f9fa 0%, rgba(100, 41, 117, 0.25) 100%)' }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        <div className="text-center mt-4">
          ...
          <p className="text-gray-600 text-lg" style={{ fontFamily: 'Inter' }}>
            Invite friends or family to be your trusted allies. When you need support, they'll be ready to step in with just one tap.
          </p>
        </div>
      </div>
